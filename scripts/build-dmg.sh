...
[ -f "$MOUNTED_APP/Contents/Resources/engine/presets/preset-liang-ancestor/theme.json" ] \
  && [ -f "$MOUNTED_APP/Contents/Resources/engine/presets/preset-liang-ancestor/liang-evolution.webm" ] \
