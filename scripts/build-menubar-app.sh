...
PUBLIC_PRESET="preset-liang-ancestor"
PUBLIC_PRESET_SHA256="9ce728aff0051edd087a03a0acb084ce8c5a0f5d2d349bcec326cd1a4ae328de"
PUBLIC_PRESET_THEME_SHA256="36b0eacdbfefba443dc855a564cff7d9ee3b6beb5e52c7046ae8610a044533a9"
PUBLIC_PRESET_VIDEO_SHA256="216f2bace19a9b8f11473272930e2549abb6a5e9a33b5434a58c4ecb6578c181"
...
actual_public_preset_video_sha256="$(LC_ALL=C /usr/bin/shasum -a 256 \
  "$ROOT/presets/$PUBLIC_PRESET/liang-evolution.webm" | /usr/bin/awk '{print $1}')"
[ "$actual_public_preset_video_sha256" = "$PUBLIC_PRESET_VIDEO_SHA256" ] \
  || { printf 'Reviewed public preset video hash changed: %s\n' "$actual_public_preset_video_sha256" >&2; exit 1; }
