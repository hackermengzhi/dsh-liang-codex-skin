...
FALLBACK_FIXTURE="$PROJECT_ROOT/docs/images/gallery/skin-01.jpg"
if [ ! -f "$FALLBACK_FIXTURE" ]; then
  FALLBACK_FIXTURE="$ROOT/tests/fixtures/cross-platform-skin-01.jpg"
fi
...
make_fallback_archive() {
  ...
  /bin/cp "$FALLBACK_FIXTURE" "$source_dir/background.jpg"
  "$NODE" -e '
